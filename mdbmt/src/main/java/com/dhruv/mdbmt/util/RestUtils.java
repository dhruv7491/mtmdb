...
public class RestUtils {
	...
	public static <T> ResponseEntity<RestResponse<?>> errorResponseWithPayload(String errorMessage,
			HttpStatus statusCode, T payload) {
		return new ResponseEntity<RestResponse<?>>(new RestResponse<T>(Boolean.FALSE, errorMessage, payload),
				statusCode);
